...
AntiZoomAndPan.prototype.init = function () {
  ...
  this.y_trans = 0;
  this.scale = 1;
  this.lastTM = document.createElementNS("http://www.w3.org/2000/svg", 'svg').createSVGMatrix();
...
AntiZoomAndPan.prototype.update = function () {
  ...
  var matrix = viewbox != null ? viewbox.getTM() : document.createElementNS("http://www.w3.org/2000/svg", 'svg').createSVGMatrix();
  console.log(document.createElementNS("http://www.w3.org/2000/svg", 'svg').currentTranslate)
  var trans = document.createElementNS("http://www.w3.org/2000/svg", 'svg').currentTranslate;
